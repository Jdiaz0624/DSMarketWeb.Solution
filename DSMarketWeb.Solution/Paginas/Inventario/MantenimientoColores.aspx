...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div id="DivBloqueConsulta" runat="server">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <asp:Label ID="lbColoresConsulta" runat="server" Text="Color" CssClass="Letranegrita"></asp:Label>
                    <asp:TextBox ID="txtColoresConsulta" runat="server" CssClass="form-control" MaxLength="100"></asp:TextBox>
                </div>
            </div>
            <br />
           <div align="center">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th align="left" style="width:80%"> COLOR </th>
        ...
        <div id="DivBloqueMantenimiento" runat="server">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <asp:Label ID="lbColoresMantenimiento" runat="server" Text="Color" CssClass="Letranegrita"></asp:Label>
                    <asp:TextBox ID="txtColoresMantenimiento" runat="server" CssClass="form-control" AutoCompleteType="Disabled" MaxLength="100"></asp:TextBox>
                </div>
            </div>
            <div class="form-check-inline">
                <div class="form-group form-check">
                    <asp:CheckBox ID="cbEstatusColoresMantenimiento" runat="server" Text="Estatus" CssClass="form-check-input" />
                </div>
            </div>
            <div align="center">
