<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="MantenimientoCondiciones.aspx.cs" Inherits="DSMarketWeb.Solution.Paginas.MantenimientoCondiciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#<%=btnGuardar.ClientID%>").click(function () {
                var Condicion = $("#<%=txtCondicionesMantenimiento.ClientID%>").val().length;
                if (Condicion < 1) {
                    alert("El campo condición no puede estar vacio para realizar esta operación, favor de verificar.");
    ...
    <div class="container-fluid">
        ...
        <div id="DivBloqueConsulta" runat="server">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <asp:Label ID="lbCondicionesConsulta" runat="server" Text="Condiciones" CssClass="Letranegrita"></asp:Label>
                    <asp:TextBox ID="txtCondicionesConsulta" runat="server" CssClass="form-control" MaxLength="100"></asp:TextBox>
                </div>
            </div>
            <br />
           <div align="center">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th align="left" style="width:80%"> CONDICIONES </th>
                            <th align="left" style="width:10%"> ESTATUS </th>
                        </tr>
                    </thead>
                    <tbody>
                        <asp:Repeater ID="rpCondiciones" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <asp:HiddenField ID="hfIdCondiciones" runat="server" Value='<%# Eval("IdCondicion") %>' />
                                    ...
                                    <td align="left" style="width:80%"> <%# Eval("Condicion") %> </td>
        ...
        <div id="DivBloqueMantenimiento" runat="server">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <asp:Label ID="lbCondicionesMantenimiento" runat="server" Text="Condiciones" CssClass="Letranegrita"></asp:Label>
                    <asp:TextBox ID="txtCondicionesMantenimiento" runat="server" CssClass="form-control" AutoCompleteType="Disabled" MaxLength="100"></asp:TextBox>
                </div>
            </div>
            <div class="form-check-inline">
                <div class="form-group form-check">
                    <asp:CheckBox ID="cbEstatusCondicionesMantenimiento" runat="server" Text="Estatus" CssClass="form-check-input" />
                </div>
            </div>
            <div align="center">
