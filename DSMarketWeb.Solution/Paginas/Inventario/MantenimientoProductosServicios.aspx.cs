...
namespace DSMarketWeb.Solution.Paginas.Inventario
{
    public partial class MantenimientoProductosServicios : System.Web.UI.Page
    {
        ...
        private void MostrarListadoInventario() {
            //FILTROS
            DateTime? _FechaDesde = string.IsNullOrEmpty(txtFechaDesdeConsulta.Text.Trim()) ? new Nullable<DateTime>() : Convert.ToDateTime(txtFechaDesdeConsulta.Text);
            ...
            else if (cbProductosVendisodDescartados.Checked == false) {
                if (cbAgregarRangoFecha.Checked == true) {
                    ...
                    if (BuscarRegistros.Count() < 1) {
                        ...
                        Paginar(ref RVListadoProducto, BuscarRegistros, 10, ref lbCantidadPaginaVariable, ref LinkPrimeraPagina, ref LinkAnterior, ref LinkSiguiente, ref LinkUltimo);
                        ...
                        foreach (var n in BuscarRegistros)
                        {
                            ...
                            CapitalInvertido = (decimal)n.CapilalInvertido;
                            GananciaAproximada = (decimal)n.GananciaAproximada;
                        }
        ...
        private void GnerarGraficoTipoProducto() {
            ...
            Comando.Parameters.AddWithValue("@IdProducto", SqlDbType.Decimal).Value = _IdProducto;
            Comando.Parameters.AddWithValue("@NumeroConector", SqlDbType.Decimal).Value = _NumeroConector;
            Comando.Parameters.AddWithValue("@Descripcion", SqlDbType.VarChar).Value = _Descripcion;
            Comando.Parameters.AddWithValue("@CodigoBarra", SqlDbType.VarChar).Value = _CodigoBarra;
            Comando.Parameters.AddWithValue("@Referencia", SqlDbType.VarChar).Value = _Referencia;
            Comando.Parameters.AddWithValue("@FechaDesde", SqlDbType.Date).Value = _FechaDesde;
            Comando.Parameters.AddWithValue("@FechaHasta", SqlDbType.Date).Value = _FechaHasta;
            Comando.Parameters.AddWithValue("@IdTipoProducto", SqlDbType.Decimal).Value = _IdTipoProducto;
            Comando.Parameters.AddWithValue("@IdCategoria", SqlDbType.Decimal).Value = _IdCategoria;
            Comando.Parameters.AddWithValue("@IdUnidadMedida", SqlDbType.Decimal).Value = _IdUnidadMedida;
            Comando.Parameters.AddWithValue("@IdMarca", SqlDbType.Decimal).Value = _IdMarca;
            Comando.Parameters.AddWithValue("@IdModelo", SqlDbType.Decimal).Value = _IdModelo;
            Comando.Parameters.AddWithValue("@IdColor", SqlDbType.Decimal).Value = _IdColor;
            Comando.Parameters.AddWithValue("@IdCapacidad", SqlDbType.Decimal).Value = _Idcapacidad;
            Comando.Parameters.AddWithValue("@IdCondicion", SqlDbType.Decimal).Value = _IdCondicion;
            Comando.Parameters.AddWithValue("@TieneOferta", SqlDbType.Bit).Value = _TieneOferta;
            Comando.Parameters.AddWithValue("@EstatusProducto", SqlDbType.Bit).Value = _EstatusProducto;
            Comando.Parameters.AddWithValue("@NumeroSeguimiento", SqlDbType.VarChar).Value = _NumeroSeguimiento;
            Comando.Parameters.AddWithValue("@TipoGraficoGenerar", SqlDbType.Int).Value = 1;
        ...
        private void GenerarGraficoMarcas() {
            ...
            Comando.Parameters.AddWithValue("@EstatusProducto", SqlDbType.Bit).Value = _EstatusProducto;
            Comando.Parameters.AddWithValue("@NumeroSeguimiento", SqlDbType.VarChar).Value = _NumeroSeguimiento;
            Comando.Parameters.AddWithValue("@TipoGraficoGenerar", SqlDbType.Int).Value = 2;
        ...
        private void GenerarGraficoServicios() {
            ...
            Comando.Parameters.AddWithValue("@EstatusProducto", SqlDbType.Bit).Value = _EstatusProducto;
            Comando.Parameters.AddWithValue("@NumeroSeguimiento", SqlDbType.VarChar).Value = _NumeroSeguimiento;
            Comando.Parameters.AddWithValue("@TipoGraficoGenerar", SqlDbType.Int).Value = 3;
      ...
      //      lbNumeroVariable.Text = "1";
       //     BindDataIntoRepeater(10);
        ...
        private void GuardarImagenProducto(decimal IdProducto, decimal NumeroConector) {
            int TamanioImagen = UpImagen.PostedFile.ContentLength;
            byte[] ImagenOriginal = new byte[TamanioImagen];
            UpImagen.PostedFile.InputStream.Read(ImagenOriginal, 0, TamanioImagen);
            System.Drawing.Bitmap ImagenOriginalBinaria = new System.Drawing.Bitmap(UpImagen.PostedFile.InputStream);

            //REDIRECCIONAMOS EL TAMAÑO DE LA IMAGEN A VOLUNTAD
            ...
            SqlConnection ConexionBD = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DSMarketWEBConexion"].ConnectionString);
            SqlCommand Guardar = new SqlCommand("EXEC [Inventario].[SP_GUARDAR_FOTO_PRODUCTO] @IdProducto,@NumeroConector,@FotoProducto ", ConexionBD);

            Guardar.Parameters.Add("@IdProducto", SqlDbType.Decimal).Value = IdProducto;
            Guardar.Parameters.Add("@NumeroConector", SqlDbType.Decimal).Value = NumeroConector;
            Guardar.Parameters.Add("@FotoProducto", SqlDbType.Image).Value = BImagenThumbNail;
        ...
        #endregion
        #region BORRAR LA FOTO DEL PRODUCTO
        private void BorrarFotoProducto(decimal IdProducto, decimal NumeroConector) {
            ...
            SqlCommand Eliminar = new SqlCommand("DELETE FROM [Inventario].[FotoProducto] WHERE IdProducto = " + IdProducto + " AND NumeroConector = " + NumeroConector, ConexionEliminar);
            ConexionEliminar.Open();
            Eliminar.ExecuteNonQuery();
            ConexionEliminar.Close();
        }
        #endregion
        #region ACTUALIZAR LA FOTO DEL PRODUCTO SELECCIONADO
        private void ActualizarFotoProductoSeleccionado(decimal IdProductoSeleccionado, decimal NumeroConectorRelacionado) {
            if (cbAgregarImagenArticulo.Checked == true && cbActualizarFotoProducto.Checked ==true) {
                try {
                    //ELIMINAMOS LA FOTO DEL PRODUCTO
                    EliminarFotoProducto(IdProductoSeleccionado, NumeroConectorRelacionado);

                    //GUARDAMOS LA NUEVA FOTO
                    GuardarImagenProducto(IdProductoSeleccionado, NumeroConectorRelacionado);
                }
                catch (Exception) {
                    ClientScript.RegisterStartupScript(GetType(), "ErrorActualizarFotoProducto()", "ErrorActualizarFotoProducto();", true);
                }
            }
        }
        #endregion
        ...
        private void MostrarFotoProductoSeleccionado(decimal IdProducto, string Accion) {
            ...
            if (ValidarFotoProducto.Count() < 1) { }
                ...
                if (Accion == "CONSULTA") {
                    ...
                    imgFotoProductoSeleccionado.ImageUrl = "data:image/jpg;base64," + Convert.ToBase64String(IMG);
                    Conexion.Close();
                }
        ...
        protected void btnNuevoConsulta_Click(object sender, EventArgs e)
        {
            ...
            cbActualizarFotoProducto.Checked = false;
            cbActualizarFotoProducto.Visible = false;
        }
        ...
        protected void btnModificarConsulta_Click(object sender, EventArgs e)
        {
            ...
            cbActualizarFotoProducto.Checked = false;
            cbActualizarFotoProducto.Visible = true;
        }
        ...
        protected void btnProcesarMantenimiento_Click(object sender, EventArgs e)
        {
            ...
            if (cbAgregarImagenArticulo.Checked == true) {
                ...
                GuardarImagenProducto(SacarID.SacarIdProductoCreado(), Convert.ToDecimal(lbNumeroConectorProducto.Text));
        ...
        protected void btnModificarMantenimiento_Click(object sender, EventArgs e)
        {
            ...
            if (ValidarClave.Count() < 1) {
                ...
                ActualizarFotoProductoSeleccionado(Convert.ToDecimal(lbIdProductoSeleccionado.Text), Convert.ToDecimal(lbNumeroConectorProducto.Text));
        ...
        protected void btnEliminarMantenimiento_Click(object sender, EventArgs e)
        {
            ...
            if (ValidarClaveSeguridad.Count() < 1) {
                ...
                EliminarFotoProducto(Convert.ToDecimal(lbIdProductoSeleccionado.Text), Convert.ToDecimal(lbNumeroConectorProducto.Text));
        ...
        protected void btnSeleccionarRegistro_Click(object sender, EventArgs e)
        {
            ...
            Paginar(ref RVListadoProducto, BuscarRegistro, 1, ref lbCantidadPaginaVariable, ref LinkPrimeraPagina, ref LinkAnterior, ref LinkSiguiente, ref LinkUltimo);
            HandlePaging(ref dtPaginacion, ref LinkBlbPaginaActualVariavle);
            ...
            foreach (var n in BuscarRegistro) {
                ...
                if (TieneImagen == true) {
                    imgFotoProductoSeleccionado.Visible = true;
                }
                else {
                    imgFotoProductoSeleccionado.Visible = false;
                }
            }
            ...
            else if (cbAgregarImagenArticulo.Checked == false) { }
