...
namespace DSMarketWeb.Logic.PrcesarMantenimientos.Inventario
{
    public class ProcesarInformacionProductos
    {
        ...
        public void ProcesarInformacion() {
            DSMarketWeb.Logic.Entidades.EntidadesInventario.EProductoServicio Procesar = new Entidades.EntidadesInventario.EProductoServicio();
            ...
            Procesar.FechaIngreso = DateTime.Now;

            var MAN = Objdata.MantenimientoProductosServicio(Procesar, Accion);
        }
    }
}
