...
namespace DSMarketWeb.Logic.PrcesarMantenimientos.Empresa
{
    ...
    {
        readonly DSMarketWeb.Logic.Logica.LogicaEmpresa.LogicaEmpresa oJdATA = new Logica.LogicaEmpresa.LogicaEmpresa();
        ...
        public void ProcesarDataCompraSuplidores() {
            DSMarketWeb.Logic.Entidades.EntidadesEmpresa.ECompraSuplidores Procesar = new Entidades.EntidadesEmpresa.ECompraSuplidores();
