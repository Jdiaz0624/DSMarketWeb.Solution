...
{
    public class EProductoServicio
    {
		...
		public string FechaAdicionaString { get; set; }
		...
		public string FechaModificaString { get; set; }

		public System.Nullable<System.DateTime> FechaIngreso { get; set; }
